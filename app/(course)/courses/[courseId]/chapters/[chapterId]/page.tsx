...
const ChapterIdPage = async ({
  ...
  return (
    <div>
      ...
      {isLocked && (
        <Banner variant="warning" label="You Need To Purchase This Course To Access This Chapter." />
      )}
            ...
            <>
              ...
              <div className="p-4">
                {attachments.map((attachment) => (
                  <a href={attachment.url} key={attachment.id} target="_blank" className="flex items-center p-3 w-full bg-sky-200 border text-sky-700 rounded-mf hover:underline">
                    <File />
