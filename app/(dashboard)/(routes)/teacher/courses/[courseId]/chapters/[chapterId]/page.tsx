...
const ChapterIdPage = async ({
  ...
  return (
    <>
        {!chapter.isPublished && (
            <Banner variant="warning" label="This Chapter Is Unpublished, It&apos;ll Be Not Visible In The Course." />
        )}
        <div className="p-6">
            <div className="flex items-center justify-between">
                <div className="w-full">
                    <Link className="flex items-center text-sm hover:opacity-75 transition mb-6" href={`/teacher/courses/${params.courseId}`}>
                ...
                <div className="space-y-4">
                    <div>
                        <div className="flex items-center gap-x-2">
                            ...
                            <h2 className="text0xl">Customize Your Chapter</h2>
                        </div>
